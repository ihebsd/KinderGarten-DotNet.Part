    ...
    var viewModels = {
        ...
        projectDetailsViewModel: function (project) {
            ...
            self.end_date_format = ko.computed(function () {
                ...
                //  M.W.H. Bug #210277: Adding a locale variable so the app can format based on user's browser language.
                return $.ig.formatter(e, "date", window.igLocale == "ja" ? "yyyy/MM/dd" : null);
