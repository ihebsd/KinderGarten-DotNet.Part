...
* [ADDED] Support for async programming (.NET 4.5+)
* [CHANGED] Other fixes and improvements, See launch blog post for full details: https://blog.pusher.com/pusher-net-server-library-v4-1-0/
